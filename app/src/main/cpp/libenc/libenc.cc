...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = jenv->FindClass("ir/mstajbakhsh/livehiddencamera/LiveBroadcaster/SrsEncoder");
    if (clz == NULL) {
        LIBENC_LOGE(
                "Class \"ir/mstajbakhsh/livehiddencamera/LiveBroadcaster/SrsEncoder\" not found");
        return JNI_ERR;
    }
