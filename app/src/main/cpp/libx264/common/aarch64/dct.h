...
int
x264_zigzag_sub_4x4ac_field_neon(dctcoef level[16], const pixel *p_src, pixel *p_dst, dctcoef *dc);

int x264_zigzag_sub_4x4_frame_neon(dctcoef level[16], const pixel *p_src, pixel *p_dst);

int
x264_zigzag_sub_4x4ac_frame_neon(dctcoef level[16], const pixel *p_src, pixel *p_dst, dctcoef *dc);
