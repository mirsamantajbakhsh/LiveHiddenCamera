...
void x264_sub4x4_dct_altivec(int16_t dct[16], uint8_t *pix1, uint8_t *pix2) {
    ...
    permHighv = (vec_u8_t) CV(0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12,
...
void x264_sub8x8_dct_altivec(int16_t dct[4][16], uint8_t *pix1, uint8_t *pix2) {
    ...
    permHighv = (vec_u8_t) CV(0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12,
                              0x13, 0x14, 0x15, 0x16, 0x17);
    permLowv = (vec_u8_t) CV(0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x18, 0x19, 0x1A, 0x1B,
                             0x1C, 0x1D, 0x1E, 0x1F);
...
void x264_zigzag_scan_4x4_frame_altivec(int16_t level[16], int16_t dct[16]) {
    ...
    const vec_u8_t sel1 = (vec_u8_t) CV(12, 13, 6, 7, 14, 15, 20, 21, 26, 27, 28, 29, 22, 23, 30,
                                        31);
